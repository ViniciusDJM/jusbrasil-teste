...
var CearaSecondInstance = entities.JudicialProcess{
	...
	ProcessParts: entities.ProcessParts{
		Appellee: []entities.ProcessPeople{
			{Name: "Ministério Público do Estado do Ceará", Kind: 0},
		},
		Appellant: []entities.ProcessPeople{
			{Name: "William Azevedo dos Santos", Kind: 0},
			{Name: "Duquesne Monteiro de Castro", Kind: 1},
		},
	},
	MovementsList: []entities.Movement{
		{
		...
		{
			Date:        time.Date(2020, time.May, 13, 0, 0, 0, 0, time.UTC),
			Description: "Baixa Definitiva",
		},
		{
			Date:        time.Date(2020, time.May, 13, 0, 0, 0, 0, time.UTC),
		...
		{
			Date:        time.Date(2018, time.May, 21, 0, 0, 0, 0, time.UTC),
			Description: "Enviados Autos Digitais da Vice-Presidência para Divisão de Recursos Privativos",
		},
		{
			Date:        time.Date(2016, time.September, 8, 0, 0, 0, 0, time.UTC),
			Description: "Processo Autuado\nDepartamento de Distribuição",
		},
	},
}
